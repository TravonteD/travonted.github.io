...
A project that really caught my eye as I was searching around was a very basic chat server written in Ruby on Rails by the team over at 37signals called [Campfire](https://once.com/campfire).
...
I set it up on a VPS[^1] and everything worked pretty much right out of the box. I did have some difficulty at first with web push notifications, but it was an issue on my end with my VIPER[^2] keys.
...
[^2]: Viper keys are used to authenticate notifications between web apps and various devices.
